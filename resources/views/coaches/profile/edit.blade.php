    ...
    <div class="container my-5">
        <div class="profile-card card shadow p-4">
            <div class="userimg" onclick="document.getElementById('image').click()">
                <img id="profileImage"
                    src="{{ Auth::user()->image ? asset('uploads/' . Auth::user()->image) : asset('images/default-profile.png') }}"
                    alt="User Image">
            </div>
        ...
        <div class="general-info">
            ...
            <form method="POST" action="{{ route('profile.updateForcoach') }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="mb-3">
                ...
                <input type="file" id="image" name="image" class="file-input" onchange="loadImage(event)"
                    style="display: none;">
